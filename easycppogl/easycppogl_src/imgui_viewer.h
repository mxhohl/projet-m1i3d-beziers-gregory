...
#ifndef EASY_CPP_OGL_IMGUI_VIEWER_H_
#define EASY_CPP_OGL_IMGUI_VIEWER_H_
...
class EASY_CPP_OGL_PUREGL_EXPORT ImGUIViewer: public PureGLViewer
{
...
class EASY_CPP_OGL_PUREGL_EXPORT ImGUIApp
{
protected:
	GLFWwindow* window_;
